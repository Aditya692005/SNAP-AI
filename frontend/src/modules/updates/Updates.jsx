      ...
      <div className="updates-page">
        <div className="updates-page-head">
          <div className="updates-page-title">
            <h1>Updates</h1>
            <p>Notifications and document activity from your workspace.</p>
          </div>
        ...
        <div className="updates-page-section">
          <div className="updates-page-section-header">
            <div>
              <h2>Activity feed</h2>
              <span>
                {updates.length > 0
            ...
            <div className="updates-page-section-actions">
              {unread > 0 && (
                <span className="updates-page-badge">{unread} unread</span>
              )}
            </div>
          </div>
          ...
          {updates.length === 0 ? (
            <div className="updates-page-empty">
              ...
              <small>
                Shared documents, retracted files, new metrics, and AI replies
                show up here.
              </small>
            </div>
          ) : (
            <ul className="updates-feed">
              {updates.map((u) => {
                const clickable =
                  isClickableDocument(u) || u.type === "ai_response";
                return (
                  <li
                    key={u.id}
                    className={`u-row ${u.read_at ? "read" : "unread"}`}
                  >
                    <div
                    ...
                    >
                      {!u.read_at && (
                        <span className="u-dot" aria-label="Unread" />
                      )}
